...
describe("onda-nativePool tests", async () => {
        ...
        describe("onda-nativePool main tests", () => {
                beforeEach(async () =>  {
                        ...
                        const onda = NatLend.createForDeploy(ondaCode, jetton_wallet_x_address.address, minter_otoken_address.address, jetton_wallet_otoken_address.address, oracle.address, owner_address.address, configuration);
